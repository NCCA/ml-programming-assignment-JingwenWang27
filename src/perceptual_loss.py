"""
Perceptual Loss Module - VGG-based Feature Matching
...
class PerceptualLoss(nn.Module):
    """
    Perceptual loss using pretrained VGG network for feature extraction
    
    Principle:

    - Compare high-level features (texture, structure) instead of raw pixels

    - Makes predictions look more realistic and natural

    - Combines pixel-level accuracy with perceptual similarity
